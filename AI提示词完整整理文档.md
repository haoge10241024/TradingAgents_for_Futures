...
**🔄 完整流程**:
```
六大分析师 → 数据分析报告 → 专业交易员评判辩论 → 风控部门风险评估 → CIO最终决策
```

**🎯 核心特色**:
- **多维度数据**: 整合技术面、基本面、情绪面、持仓面、新闻面
- **多角色辩论**: 看多vs看空的激烈辩论，避免群体思维
...
感谢您对本项目的关注！这份文档涵盖了整个TradingAgents系统的所有核心AI提示词。如有任何问题或建议，欢迎通过邮件或GitHub Issue联系。
